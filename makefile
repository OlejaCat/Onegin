...
base: main.o onegin_logic.o sorting_algorithms.o string_functions.o work_with_files.o helpful_functions.o user_interaction.o logger.o
	@$(CC) $(LINKER_FLAGS) $(CFLAGS) main.o onegin_logic.o sorting_algorithms.o string_functions.o work_with_files.o helpful_functions.o user_interaction.o logger.o -o onegin

main.o: source/main.cpp
	@$(CC) $(CFLAGS) -c source/main.cpp

onegin_logic.o: source/onegin_logic.cpp
	@$(CC) $(CFLAGS) -c source/onegin_logic.cpp

sorting_algorithms.o: source/sorting_algorithms.cpp
	@$(CC) $(CFLAGS) -c source/sorting_algorithms.cpp

string_functions.o: source/string_functions.cpp
	@$(CC) $(CFLAGS) -c source/string_functions.cpp

work_with_files.o: source/work_with_files.cpp
	@$(CC) $(CFLAGS) -c source/work_with_files.cpp

user_interaction.o: source/user_interaction.cpp
	@$(CC) $(CFLAGS) -c source/user_interaction.cpp
